import NonFungibleToken from 0xa31975fccc40116e
...
pub contract KittyItems: NonFungibleToken {
	...
	pub resource NFTMinter {
		...
		pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, metadata: {String : String}) {
            emit Minted(id: KittyItems.totalSupply, metadata: metadata)

			// deposit it in the recipient's account using their reference
			recipient.deposit(token: <-create KittyItems.NFT(initID: KittyItems.totalSupply, initMetadata: metadata))
